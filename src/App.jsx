...
const Spin = () => (
  <div style={{minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",background:"#f9f9fb"}}>
    <div style={{textAlign:"center"}}>
      <div style={{width:48,height:48,border:"4px solid rgba(251,163,28,.2)",borderTopColor:"#FBA31C",borderRadius:"50%",animation:"spin .8s linear infinite",margin:"0 auto 12px"}}/>
      <p style={{color:"#FBA31C",fontWeight:600,fontSize:14,letterSpacing:1}}>LOADING...</p>
    </div>
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/equipment/:id" element={<EquipmentDetail isAuthenticated={isAuthenticated} />} />
